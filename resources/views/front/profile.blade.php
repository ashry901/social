            ...
            <aside class="col col-xl-3 order-xl-1 col-lg-12 order-lg-1 col-12">
                <div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
                    <div class="py-4 px-3 border-bottom">
                        <img src="{{asset('ashry/front/img/p13.png')}}" class="img-fluid mt-2 rounded-circle"
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body">
                        ...
                        <div class="d-flex align-items-center osahan-post-header p-3 border-bottom people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('ashry/front/img/l8.png')}}" alt="">
                            </div>
                            <div class="font-weight-bold">
                        ...
                        <div class="d-flex align-items-center osahan-post-header p-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle" src="{{asset('ashry/front/img/l5.png')}}" alt="">
                            </div>
                            <div class="font-weight-bold">
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{asset('ashry/front/img/l3.png')}}" alt="">
                        </div>
                    ...
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{asset('ashry/front/img/l6.png')}}" alt="">
                        </div>
                    ...
                    <div class="box-body p-3">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{asset('ashry/front/img/l2.png')}}" alt="">
                        </div>
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3 border-bottom">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{asset('ashry/front/img/e1.png')}}" alt="">
                        </div>
                        <p class="mb-0">Find the most qualified people in the most unexpected places. Information for applicants to consider when applying for local positions.</p>
                    </div>
                    <div class="box-body p-3">
                        <div class="d-flex align-items-top job-item-header pb-2">
                            ...
                            <img class="img-fluid ml-auto mb-auto" src="{{asset('ashry/front/img/e2.png')}}" alt="">
                        </div>
