            ...
            <div class="col-lg-8 col-md-8">
                <div class="blog-card padding-card box shadow-sm rounded bg-white mb-3 border-0">
                    <img class="card-img-top"
                         src="{{asset('ashry/front/img/blog/2.png')}}"
                         alt="Card image cap">
                    <div class="card-body">
                        <span class="badge badge-success">House/Villa</span>
                        <h2>Possimus aut mollitia eum ipsum</h2>
                        <h6 class="mb-3"><i class="feather-calendar"></i>
                            March 09, 2020 / 3 Comments
                        </h6>
                        <p>
                        ...
                        <p>
                            Praesent eget euismod nibh. Fusce ac tellus eu nisl lobortis
                            maximus ac eget sapien. Nulla malesuada mauris non
                            nulla imperdiet ullamcorper.
                        </p>
                        <p>
                            Spacial has both a web app and an android app to make your website
                            easy and always available. It offers you all the designs in
                            collaboration with some smart people. Your projects will look
                            great everywhere you go. Use new components that come included!
                        </p>
                        <div class="row">
                        ...
                        <p>
                            ...
                            and we‘ll take care of spinning up new designs for your users
                            and making sure they’re great. Work with all types of customers
                            right out of the box while still getting paid in your preferred
                            currency.
                        </p>

                        <p class="mb-0">
                            Sed porta libero metus, nec feugiat enim pharetra vel.
                            Sed vel sagittis augue. Donec hendrerit nibh ac dolor
                            lobortis, eu varius odio sollicitudin. Proin non condimentum
                            nulla, quis dictum leo. Vestibulum lobortis urna eu mauris
                            viverra porttitor. Cras consequat leo condimentum lacus
                            viverra sollicitudin. Donec dignissim ornare est, nec
                            scelerisque purus mollis eu. Phasellus dictum suscipit ligula.
                            Donec malesuada gravida velit. Nulla egestas diam in ligula mollis,
                            nec tincidunt diam porta. Proin eleifend lacinia diam quis pretium.
                            Sed lacinia varius nisi et euismod. Ut ac arcu vulputate, porta
                            nibh non, ultricies erat. Nulla facilisi.
                        </p>
                    </div>
                ...
                <div class="padding-card reviews-card box shadow-sm rounded bg-white mb-3 border-0">
                    <div class="card-body">
                        ...
                        <div class="media mb-4">
                            <img class="d-flex mr-3 rounded"
                                 src="{{asset('ashry/front/img/user/1.jpg')}}" alt="">
                        ...
                        <div class="media">
                            <img class="d-flex mr-3 rounded"
                                 src="{{asset('ashry/front/img/user/2.jpg')}}" alt="...">
                            <div class="media-body">
                                <h5 class="mt-0">Mark Smith
                                    <small>Feb 09, 2020</small>
                                    <span class="star-rating float-right">
                                        <i class="feather-star text-warning"></i>
                                        <i class="feather-star text-warning"></i>
                                        <i class="feather-star text-warning"></i>
                                ...
                                <div class="media mt-4">
                                    <img class="d-flex mr-3 rounded"
                                         src="{{asset('ashry/front/img/user/3.jpg')}}" alt="...">
                                    <div class="media-body">
                                        <h5 class="mt-0">Ryan Printz
                                            <small>Nov 13, 2020</small>
                                            <span class="star-rating float-right">
                                                <i class="feather-star text-warning"></i>
                                                <i class="feather-star text-warning"></i>
                                                <i class="feather-star text-warning"></i>
                        ...
                        <div class="media mt-4">
                            <img class="d-flex mr-3 rounded"
                                 src="{{asset('ashry/front/img/user/5.jpg')}}" alt="...">
                            <div class="media-body">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="sidebar-card box shadow-sm rounded bg-white mb-3 border-0">
                    <div class="card-body">
                        ...
                        <a href="#"><h6>Possimus aut mollitia eum ipsum</h6></a>
                        ...
                        <a href="#">
                            <h6 class="text-dark">
                                Focus on creating and growing your projects and websites</h6>
                        </a>
                        ...
                        <a href="#">
                            <h6>
                                Vestibulum lobortis urna eu mauris viverra porttitor. Cras consequat
                            </h6>
                        </a>
                                        ...
                                        <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                            <div class="overlap-rounded-circle">
                                                <img class="rounded-circle shadow-sm"
                                                     ...
                                                     src="{{asset('ashry/front/img/p9.png')}}"
                                                     alt="..." data-original-title="Sophia Lee">
                                                <img class="rounded-circle shadow-sm"
                                                     data-toggle="tooltip"
                                                     data-placement="top" title="..."
                                                     src="{{asset('ashry/front/img/p10.png')}}"
                                                     alt="..." data-original-title="John Doe">
                                                <img class="rounded-circle shadow-sm"
                                                     data-toggle="tooltip"
                                                     data-placement="top" title="..."
                                                     src="{{asset('ashry/front/img/p11.png')}}"
                                                     alt="..." data-original-title="Julia Cox">
                                                <img class="rounded-circle shadow-sm"
                                                     data-toggle="tooltip"
                                                     data-placement="top" title="..."
                                                     src="{{asset('ashry/front/img/p12.png')}}"
                                        ...
                                        <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                            <div class="overlap-rounded-circle">
                                                <img class="rounded-circle shadow-sm"
                                                     data-toggle="tooltip"
                                                     data-placement="top"
                                                     title="..." src="{{asset('ashry/front/img/p9.png')}}"
                                                     alt="..."
                                                     data-original-title="Sophia Lee">
                                                <img class="rounded-circle shadow-sm"
                                                     data-toggle="tooltip"
                                                     data-placement="top"
                                                     title="..." src="{{asset('ashry/front/img/p10.png')}}"
                                                     alt="..."
                                                     data-original-title="John Doe">
                                                <img class="rounded-circle shadow-sm"
                                                     data-toggle="tooltip"
                                                     data-placement="top"
                                                     title="..." src="{{asset('ashry/front/img/p11.png')}}"
                                                     alt="..."
                                                     data-original-title="Julia Cox">
                                                <img class="rounded-circle shadow-sm"
                                                     data-toggle="tooltip"
                                                     data-placement="top"
                                                     title="..." src="{{asset('ashry/front/img/p12.png')}}"
                                                     alt="..."
