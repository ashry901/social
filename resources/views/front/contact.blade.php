...
<div class="py-5 bg-white">
    <div class="container">
        <div class="row align-items-center py-4">
            <div class="col-md-6">
                <h1 class="text-primary display-4 font-weight-bold">How can<br />Ashry assistants <span class="text-warning">help</span> You?</h1>
                <h5 class="mb-2 text-dark-50 font-weight-light">We'd love to talk about how we can help you.
                </h5>
            </div>
...
<div class="py-5 bg-white">
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-md-6">
                <div class="p-4 border mr-4 rounded overflow-hidden"><iframe width="100%" height="455" src="https://maps.google.com/maps?width=720&amp;height=600&amp;hl=en&amp;coord=30.9090157&amp;q=punjab+(My%20Business%20Name)&amp;ie=UTF8&amp;t=p&amp;z=8&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div>
            </div>
            <div class="col-md-6">
                <div class="mb-5">
                    <h4 class="font-weight-light mt-0">Tell us about <span class="font-weight-bold">yourself</span></h4>
                        ...
                        <div class="col">
                            <div class="form-group mb-4">
                                ...
                                <div class="position-relative icon-form-control">
                                    ...
                                    <input placeholder="Gurdeep Osahan" type="text" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col">
...
<footer class="bg-light py-4">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <p class="small text-muted mb-0">© Tarek Ashry. 2022 Ashry.</p>
