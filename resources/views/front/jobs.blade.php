                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/front/img/l1.png')}}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/front/img/p1.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/front/img/p2.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/front/img/p3.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/front/img/p4.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/front/img/p5.png')}}" alt="">
                                                    </div>
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/front/img/l2.png')}}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/front/img/p6.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/front/img/p7.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/front/img/p8.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                                </div>
                                                <div class="p-3 job-item-footer">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/front/img/p9.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/front/img/p10.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/front/img/p11.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/front/img/p12.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                                </div>
                                                <div class="p-3 job-item-footer">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/front/img/p13.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/front/img/p1.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/front/img/p2.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/front/img/p3.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                                </div>
                                                <div class="p-3 job-item-footer">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/front/img/p4.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/front/img/p5.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/front/img/p6.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/front/img/p7.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                                </div>
                                                <div class="p-3 job-item-footer">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/front/img/p8.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/front/img/p9.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/front/img/p10.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/front/img/p11.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                                </div>
                                                <div class="p-3 job-item-footer">
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Sophia Lee" src="{{asset('ashry/front/img/p12.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="John Doe" src="{{asset('ashry/front/img/p13.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/front/img/p2.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                        ...
                                        <a href="{{ route('job-profile') }}">
                                            <div class="border job-item mb-3">
                                                <div class="d-flex align-items-center p-3 job-item-header">
                                                    ...
                                                    <img class="img-fluid ml-auto" src="{{asset('ashry/front/img/l8.png')}}" alt="">
                                                </div>
                                                <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                        ...
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Julia Cox" src="{{asset('ashry/front/img/p7.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/front/img/p1.png')}}" alt="">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="Robert Cook" src="{{asset('ashry/front/img/p3.png')}}" alt="">
                                                    </div>
                                                    <span class="font-weight-bold text-primary">18 connections</span>
                                ...
                                <div class="row">
                                        ...
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/front/img/l3.png')}}" alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <div class="mb-3">
                                                        <h6 class="font-weight-bold mb-0"><a class="text-dark" href="#">C# Developer</a></h6>
                                                        <a class="d-inline-block small pt-1" href="#">
                                    ...
                                    <div class="col-md-6">
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/front/img/l2.png')}}" alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <div class="mb-3">
                                                        <h6 class="font-weight-bold mb-0">
                                                            <a class="text-dark" href="{{ route('job-profile') }}">Junior UX Designer</a></h6>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a class="small"
                                                           href="{{ route('job-profile') }}">Open jobs</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/front/img/l3.png')}}"
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a class="small" href="{{ route('job-profile') }}">
                                                            Open jobs
                                                        </a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/front/img/l4.png')}}"
                                                         alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/front/img/l5.png')}}" alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <div class="mb-3">
                                                        <h6 class="font-weight-bold mb-0">
                                                            <a class="text-dark" href="{{ route('job-profile') }}">
                                                                Junior UX Designer
                                                            </a>
                                                        </h6>
                                    ...
                                    <div class="col-md-6">
                                        <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                            <div class="media">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid" src="{{asset('ashry/front/img/l6.png')}}" alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                                    <div class="mb-3">
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/front/img/p6.png')}}" alt="" data-original-title="Sophia Lee">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/front/img/p7.png')}}" alt="" data-original-title="John Doe">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/front/img/p8.png')}}" alt="" data-original-title="Julia Cox">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/front/img/p9.png')}}" alt="" data-original-title="Robert Cook">
                                                    </div>
                                                ...
                                                <div class="network-item-footer py-3 d-flex text-center">
                                                    ...
                                                    <div class="col-6 pr-3 pl-1">
                                                        <button type="button" class="btn btn-outline-primary btn-sm btn-block">
                                                            <i class="feather-user-plus"></i> Follow </button>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p10.png')}}" alt="" data-original-title="Sophia Lee">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p11.png')}}" alt="" data-original-title="John Doe">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p12.png')}}" alt="" data-original-title="Julia Cox">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p13.png')}}" alt="" data-original-title="Robert Cook">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                                </div>
                                                <div class="network-item-footer py-3 d-flex text-center">
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/front/img/p1.png')}}" alt="" data-original-title="Sophia Lee">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/front/img/p3.png')}}" alt="" data-original-title="Julia Cox">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="" src="{{asset('ashry/front/img/p4.png')}}" alt="" data-original-title="Robert Cook">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                                </div>
                                                <div class="network-item-footer py-3 d-flex text-center">
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p5.png')}}" alt="" data-original-title="Sophia Lee">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p6.png')}}" alt="" data-original-title="John Doe">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p7.png')}}" alt="" data-original-title="Julia Cox">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p8.png')}}" alt="" data-original-title="Robert Cook">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                                </div>
                                                <div class="network-item-footer py-3 d-flex text-center">
                                        ...
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                ...
                                                <div class="d-flex align-items-center p-3 border-top border-bottom network-item-body">
                                                    <div class="overlap-rounded-circle">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p9.png')}}" alt="" data-original-title="Sophia Lee">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p13.png')}}" alt="" data-original-title="Julia Cox">
                                                        <img class="rounded-circle shadow-sm" data-toggle="tooltip" data-placement="top"
                                                             title="..." src="{{asset('ashry/front/img/p8.png')}}" alt="" data-original-title="Robert Cook">
                                                    </div>
                                                    <span class="font-weight-bold small text-primary">4 mutual connections</span>
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle" src="{{asset('ashry/front/img/p7.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                        <h6 class="font-weight-bold text-dark mb-0">Julia Cox</h6>
                                                        <div class="small text-black-50">Art Designer</div>
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{ route('profile') }}">
                                            <div class="border network-item rounded mb-3">
                                                <div class="p-3 d-flex align-items-center network-item-header">
                                                    <div class="dropdown-list-image mr-3">
                                                        <img class="rounded-circle" src="{{asset('ashry/front/img/p8.png')}}" alt="">
                                                    </div>
                                                    <div class="font-weight-bold">
                                                        <h6 class="font-weight-bold text-dark mb-0">Robert Cook</h6>
                                                        <div class="small text-black-50">Graphic Designer</div>
                ...
                <div class="shadow-sm rounded bg-white job-item-2 p-3 mb-3">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="mb-3">
                                <h6 class="font-weight-bold mb-0">
                                    <a class="text-dark" href="{{ route('job-profile') }}">C# Developer</a></h6>
                                <a class="d-inline-block small pt-1" href="{{ route('job-profile') }}">
                                    <span class="text-warning">
                                        <span class="feather-star"></span>
                                        <span class="feather-star"></span>
                        ...
                        <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                            <div class="dropdown-list-image mr-3">
                                <img class="rounded-circle"
                                     src="{{asset('ashry/front/img/p10.png')}}" alt="">
                                <div class="status-indicator bg-success"></div>
                            </div>
                            <div class="font-weight-bold mr-2">
