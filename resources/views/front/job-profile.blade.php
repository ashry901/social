...
<div class="profile-cover text-center">
    <img class="img-fluid"
         src="{{asset('ashry/front/img/job-profile.jpg')}}" alt="...">
</div>
                ...
                <div class="d-flex align-items-center py-3">
                    <div class="profile-left">
                        ...
                        <p class="mb-0 text-muted">
                            <a class="mr-2 font-weight-bold" href="#">Envato</a>
                            <i class="feather-map-pin"></i>
                            Melbourne, AU -- DatePosted 2 weeks ago
                        </p>
                    </div>
                ...
                <div class="box shadow-sm border rounded bg-white mb-3">
                    ...
                    <div class="box-body p-3">
                        <div class="gallery-box-main">
                            ...
                            <div class="gallery-box">
                                <img class="img-fluid" src="{{asset('ashry/front/img/p10.png')}}" alt="...">
