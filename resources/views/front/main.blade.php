                ...
                <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
                    <div class="box shadow-sm border rounded bg-white mb-3 osahan-share-post">
                        <ul class="nav nav-justified border-bottom osahan-line-tab" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab"
                                   ...
                                   aria-selected="false"><i class="feather-image"></i>
                                    Upload a photo
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab"
                                   ...
                                   aria-selected="false"><i class="feather-clipboard"></i>
                                    Write an article
                                </a>
                            </li>
                        </ul>
                        ...
                        <textarea placeholder="Write your thoughts..."
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel"
                                ...
                                <div class="p-3 w-100">
                    <textarea placeholder="Write your thoughts..."
                              class="form-control border-0 p-0 shadow-none" rows="3">
                    </textarea>
                                </div>
                            </div>
                    ...
                    <div class="box shadow-sm border rounded bg-white mb-3 osahan-post">
                        ...
                        <div class="p-3 border-bottom osahan-post-body">
                            <p class="mb-0">Tmpo incididunt ut labore et dolore magna aliqua.
                                        ...
                                        <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                            <div class="overlap-rounded-circle d-flex">
                                                <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                     data-placement="top" title="" src="{{asset('ashry/front/img/p1.png')}}" alt="..."
                                                     data-original-title="Sophia Lee">
                                                <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                     data-placement="top" title="" src="{{asset('ashry/front/img/p2.png')}}" alt="..."
                                                     data-original-title="John Doe">
                                                <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                     data-placement="top" title="" src="{{asset('ashry/front/img/p3.png')}}" alt="..."
                                                     data-original-title="Julia Cox">
                                                <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                     data-placement="top" title="" src="{{asset('ashry/front/img/p4.png')}}" alt="..."
                                                     data-original-title="Robert Cook">
                                                <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                     data-placement="top" title="" src="{{asset('ashry/front/img/p5.png')}}" alt="..."
                                                     data-original-title="Sophia Lee">
                                            </div>
                                ...
                                <a href="{{ route('job-profile') }}">
                                    <div class="shadow-sm border rounded bg-white job-item job-item mr-2 mt-3 mb-3">
                                        ...
                                        <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                            <div class="overlap-rounded-circle d-flex">
                                                <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                     data-placement="top" title="" src="{{asset('ashry/front/img/p13.png')}}" alt="..."
                                                     data-original-title="Sophia Lee">
                                                <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                     data-placement="top" title="" src="{{asset('ashry/front/img/p1.png')}}" alt="..."
                                                     data-original-title="John Doe">
                                ...
                                <a href="{{ route('job-profile') }}">
                                    <div class="shadow-sm border rounded bg-white job-item job-item mr-2 mt-3 mb-3">
                                        ...
                                        <div class="d-flex align-items-center p-3 border-top border-bottom job-item-body">
                                            <div class="overlap-rounded-circle d-flex">
                                                <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                     data-placement="top" title="" src="{{asset('ashry/front/img/p12.png')}}" alt="..."
                                                     data-original-title="Sophia Lee">
                                                <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                     data-placement="top" title="" src="{{asset('ashry/front/img/p13.png')}}" alt="..."
                                                     data-original-title="John Doe">
                    ...
                    <div class="box mb-3 shadow-sm border rounded bg-white osahan-post">
                        ...
                        <div class="p-3 border-bottom osahan-post-body">
                            ...
                            <img src="{{asset('ashry/front/img/post1.png')}}" class="img-fluid" alt="Responsive image">
                        </div>
                        <div class="p-3 border-bottom osahan-post-footer">
                            <a href="#" class="mr-3 text-secondary"><i class="feather-heart text-danger"></i> 16</a>
                            <a href="#" class="mr-3 text-secondary"><i class="feather-message-square"></i> 8</a>
                        ...
                        <div class="p-3 d-flex align-items-top border-bottom osahan-post-comment">
                            ...
                            <div class="font-weight-bold">
                                ...
                                <div class="small text-gray-500">
                                    Ratione voluptatem sequi en lod nesciunt.
                                    Neque porro quisquam est, quinder dolorem
                ...
                <aside class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-6 col-12">
                    <div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
                        <div class="py-4 px-3 border-bottom">
                            <img src="{{asset('ashry/front/img/p13.png')}}" class="img-fluid mt-2 rounded-circle" alt="...">
                    ...
                    <div class="box mb-3 shadow-sm rounded bg-white view-box overflow-hidden">
                        ...
                        <div class="overflow-hidden border-top text-center">
                            <img src="{{asset('ashry/front/img/chart.png')}}" class="img-fluid" alt="...">
                        </div>
                    </div>
                    <div class="box shadow-sm mb-3 rounded bg-white ads-box text-center">
                        <img src="{{asset('ashry/front/img/job1.png')}}" class="img-fluid" alt="...">
                        ...
                        <div class="box-body p-3">
                            <div class="gallery-box-main">
                                <div class="gallery-box">
                                    <img class="img-fluid" src="{{asset('ashry/front/img/p4.png')}}" alt="...">
                                    <img class="img-fluid" src="{{asset('ashry/front/img/p5.png')}}" alt="...">
                                    <img class="img-fluid" src="{{asset('ashry/front/img/p6.png')}}" alt="...">
                                </div>
                                <div class="gallery-box">
                                    <img class="img-fluid" src="{{asset('ashry/front/img/p7.png')}}" alt="...">
                                    <img class="img-fluid" src="{{asset('ashry/front/img/p8.png')}}" alt="...">
                                    <img class="img-fluid" src="{{asset('ashry/front/img/p9.png')}}" alt="...">
                                </div>
                                <div class="gallery-box">
                                    <img class="img-fluid" src="{{asset('ashry/front/img/p10.pn')}}g" alt="...">
                                    <img class="img-fluid" src="{{asset('ashry/front/img/p11.png')}}" alt="...">
                                    <img class="img-fluid" src="{{asset('ashry/front/img/p12.png')}}" alt="...">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="box shadow-sm mb-3 rounded bg-white ads-box text-center overflow-hidden">
                        <img src="{{asset('ashry/front/img/ads1.png')}}" class="img-fluid" alt="...">
                        <div class="p-3 border-bottom">
