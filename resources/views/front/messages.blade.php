                            ...
                            <div class="osahan-chat-left">
                                ...
                                <div class="osahan-chat-list">
                                    <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle"
                                                 src="{{asset('ashry/front/img/p9.png')}}" alt="">
                                        </div>
                                    ...
                                    <div class="p-3 d-flex align-items-center bg-light border-left border-primary  border-bottom osahan-post-header overflow-hidden">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle"
                                                 src="{{asset('ashry/front/img/p1.png')}}" alt=""></div>
                                        <div class="font-weight-bold mr-1 overflow-hidden">
                                    ...
                                    <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle"
                                                 src="{{asset('ashry/front/img/p3.png')}}" alt=""></div>
                                        <div class="font-weight-bold mr-1 overflow-hidden">
                                    ...
                                    <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle"
                                                 src="{{asset('ashry/front/img/p4.png')}}" alt=""></div>
                                        <div class="font-weight-bold mr-1 overflow-hidden">
                        ...
                        <div class="col-lg-7 col-xl-8 px-0">
                            ...
                            <div class="osahan-chat-box p-3 border-top border-bottom bg-light">
                                        ...
                                        <p>welcome to Live Chat! My name is Jason. How can I help you today?
                                            <a href="#">
                                                <span class="__cf_email__"
                                                      data-cfemail="6b020a0604180a030a052b0c060a020745080406">
                                                    [email&#160;protected]
                                                </span>
                                            </a>
                                        </p>
                                ...
                                <div class="d-flex align-items-center osahan-post-header">
                                    <div class="dropdown-list-image mr-3 mb-auto">
                                        <img class="rounded-circle"
                                             src="{{asset('ashry/front/img/p8.png')}}" alt=""></div>
                                    <div class="mr-1">
                                ...
                                <div class="d-flex align-items-center osahan-post-header">
                                    ...
                                    <div class="mr-1">
                                        ...
                                        <p>wI understand your concern… I wouldn’t want my child’s gift to arrive
                                            late either. It looks like your order is set to arrive in 2
                                            business days, so it should arrive by Friday, just in time!</p>
                                    </div>
                                    <span class="ml-auto mb-auto">
                                        <div class="text-right text-muted pt-1 small">00:21PM</div>
                                    </span>
                                ...
                                <div class="d-flex align-items-center osahan-post-header">
                                    ...
                                    <div class="mr-1">
                                        ...
                                        <p>Great, thank you! Yes, I also wanted to make sure I entered the right
                                            shipping address. My address is 12390 Mulberry Ln, Coral Springs,
                                            FL 33067. Is that where it’s being shipped to?
                                        </p>
                                    </div>
                                    <span class="ml-auto mb-auto">
                                        <div class="text-right text-muted pt-1 small">00:21PM</div>
